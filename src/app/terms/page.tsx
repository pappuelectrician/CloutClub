...
export const metadata = {
    ...
    description: 'Terms and conditions for Clout Club.'
};
...
export default function TermsPage() {
    return (
        <div style={{ paddingTop: '150px', paddingBottom: '100px', paddingLeft: '5%', paddingRight: '5%', minHeight: '100vh', background: 'var(--background)' }}>
            ...
            <p style={{ opacity: 0.8, lineHeight: '1.6' }}>Placeholder text for Terms &amp; Conditions. Replace this with the actual legal content.</p>
        </div>
    );
}
